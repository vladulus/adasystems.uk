...
<div class="page-wrapper">
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Register a new tracking device and set its status.</p>
        </div>
    ...
    <div class="card form-card">
        <form action="{{ route('management.devices.store') }}" method="POST" class="device-form">
            @csrf
                ...
                <div class="form-section">
                    ...
                    <div class="field-group">
                        ...
                        <input
                            ...
                            placeholder="Internal name, e.g. Truck 01 – Main unit"
                            required
                        >
                        @error('name')
                    ...
                    <div class="field-group">
                        ...
                        <textarea
                            ...
                            placeholder="Installation location, comments, etc."
                        >{{ old('notes') }}</textarea>
                        @error('notes')
                            <p class="field-error">{{ $message }}</p>
                        @enderror
                ...
                <div class="form-section">
                    ...
                    <div class="field-group">
                        ...
                        <input
                            ...
                            placeholder="e.g. Demo, Test, Reserved"
                        >
                        @error('tag')
                            <p class="field-error">{{ $message }}</p>
                        @enderror
