...
.input-error { border-color:#f97373; }
.field-error {
    font-size:0.75rem;
    color:#b91c1c;
    margin-top:0.15rem;
        ...
        <div class="form-grid">
            ...
            <div>
                ...
                <div class="field-grid-2">
                    ...
                    <div class="field-group">
                        ...
                        <input type="date"
                               ...
                               value="{{ old('hire_date', optional($driver->hire_date)->format('Y-m-d')) }}">
                        @error('hire_date')
                            <p class="field-error">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="field-group">
                    ...
                    <textarea name="address"
                              ...
                              placeholder="Street, city, ZIP, country">{{ old('address', $driver->address) }}</textarea>
                    @error('address')
                        <p class="field-error">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="field-group">
                    ...
                    <textarea name="notes"
                              ...
                              placeholder="Additional notes, restrictions, comments">{{ old('notes', $driver->notes) }}</textarea>
                    @error('notes')
                        <p class="field-error">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div>
                ...
                <div class="field-grid-2">
                    <div class="field-group">
                        ...
                        <input type="date"
                               ...
                               value="{{ old('license_issue_date', optional($driver->license_issue_date)->format('Y-m-d')) }}">
                ...
                <div class="field-group">
                    ...
                    @php $status = old('status', $driver->status); @endphp
                ...
                <div class="field-group">
                    <label class="field-label">Assigned vehicles</label>
                    @php
